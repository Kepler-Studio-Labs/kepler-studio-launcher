...
import TeleportationText from './teleportation-text'
        ...
        return (
          ...
          >
              ...
              {index <= value && (
                <CheckFilled
                  className={cn(
                    ...
                    value === index && 'text-black dark:text-violet-400 opacity-100'
                  )}
                />
              )}
            </div>
            ...
            >
              {index === 3 ? (
                <>
                  {value === index && <TeleportationText text={loadingState.text} />}
                  {value !== index && loadingState.text}
                </>
              ) : (
                loadingState.text
              )}
...
export const AuthLoader = ({ loadingStates, currentState, loading, duration = 2000 }) => {
  return (
